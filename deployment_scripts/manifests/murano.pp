...
if (roles_include(['primary-controller', 'controller']) and ! $murano_hash['murano_standalone']) or
  ...
  # workaround for ssl mode
  murano_config {
    'glare/endpoint_type':   value => 'internalURL';
    'neutron/endpoint_type': value => 'internalURL';
    'murano/endpoint_type':  value => 'internalURL';
    'heat/endpoint_type':    value => 'internalURL';
  }
