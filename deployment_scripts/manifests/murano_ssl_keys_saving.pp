...
if !empty($ssl_hash) {
  $public_service = try_get_value($ssl_hash, "murano_public", false)
  $public_usercert = try_get_value($ssl_hash, "murano_public_usercert", false)
  $public_certdata = try_get_value($ssl_hash, "murano_public_certdata/content", '')
  $internal_service = try_get_value($ssl_hash, "murano_internal", false)
  $internal_usercert = try_get_value($ssl_hash, "murano_internal_usercert", false)
  $internal_certdata = try_get_value($ssl_hash, "murano_internal_certdata/content", '')
  $admin_service = try_get_value($ssl_hash, "murano_admin", false)
  $admin_usercert = try_get_value($ssl_hash, "murano_admin_usercert", false)
  $admin_certdata = try_get_value($ssl_hash, "murano_admin_certdata/content", '')
